...
export class createEntity1576487044174 implements MigrationInterface {
    name = 'createEntity1576487044174'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "street" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "zip" character varying NOT NULL, "created_at" date NOT NULL DEFAULT now(), "last_login" TIMESTAMP WITH TIME ZONE, "last_logout" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "production_machines" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "PK_254580e89662da2f9dfbaee813a" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "production_tasks" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "quantity_planned" integer NOT NULL, "quantity_made" integer NOT NULL DEFAULT 0, "status" boolean NOT NULL DEFAULT false, "duration" TIME NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "customer_id" integer NOT NULL, "user_id" integer NOT NULL, "master_id" integer NOT NULL, "production_machine_id" integer NOT NULL, CONSTRAINT "PK_2e650b46a4eb798dbb97b61973e" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "customers" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "street" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "zip" character varying NOT NULL, "tax" character varying NOT NULL, "created_at" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_8536b8b85c06969f84f0c098b03" UNIQUE ("email"), CONSTRAINT "PK_133ec679a801fab5e070f73d3ea" PRIMARY KEY ("id"))`, undefined);
