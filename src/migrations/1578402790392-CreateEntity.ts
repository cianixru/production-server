...
export class CreateEntity1578402790392 implements MigrationInterface {
    name = 'CreateEntity1578402790392'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TYPE "users_auth_role_enum" AS ENUM('WORKER_ROLE', 'MASTER_ROLE', 'ADMIN_ROLE')`, undefined);
        ...
        await queryRunner.query(`CREATE TYPE "users_salary_contract_type_enum" AS ENUM('Full-time', 'Part-time', 'Fixed-term', 'Contractor', 'Volunteers')`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP TYPE "users_salary_contract_type_enum"`, undefined);
