...
export class createEntity1576431056630 implements MigrationInterface {
    name = 'createEntity1576431056630'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "production_tasks" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "quantity" integer NOT NULL, "status" boolean NOT NULL, "duration" TIME NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "customer_id" integer NOT NULL, "user_id" integer NOT NULL, "master_id" integer NOT NULL, "production_machine_id" integer NOT NULL, CONSTRAINT "PK_2e650b46a4eb798dbb97b61973e" PRIMARY KEY ("id"))`, undefined);
